...
target = ["ARR_DEL15","ARR_DELAY","AIR_TIME"] #,"CANCELLED"
...
import random
rows = random.sample(jan.index,100)
jan1 = jan.ix[rows]
jan_rest = jan.drop(rows)

jan1 = jan1.groupby(coi_pred)[target].agg([np.mean])
