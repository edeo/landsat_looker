...
'''
The Wage and Hour division (from here on refered to as WHD) of the Department of Labor enforces minimum wage and overtime. 
The data set I am using is all of the investitations from new york state from 2008 onward.
I choose 2008 to try and capture some of the restuarantes that are inspected in the health data. 
going back further risks having false matches, where a street address had a business that was investigated, but is no longer in business.
For example, the WHD data set goes back to 1985, it is possible it would have a business in it from 1987 that had an overtime, and
then in 2014 a new business would be in the same place. 
...
'''
This now gives me the wage and hour invstigations in new york city. As the data from Wage and Hour names the city differently than 
the health data, I needed to do this to split the wage and hour data.
'''
